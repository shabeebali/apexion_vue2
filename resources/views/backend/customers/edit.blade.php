            ...
            <v-card-text>
                <v-form ref="form" v-on:submit.prevent="">
                    ...
                    <v-row justify="space-around">
                        <v-col>
                            <v-btn tile color="primary" @click="save()" :loading="btnloading">Update</v-btn>
    ...
    var vue = new Vue({
        ...
        methods:{
            ...
            deletePhone(index,index2){
                this.waitDialog = true
                axios.post('customers/delete_phone/'+this.fd.addresses[index].phones[index2].id).then((res)=>{
                    ...
                    if(error.response.status == 403){
                        ...
                        this.triggerSb('Something went wrong','error')
                    }
                })
            },
            deleteAddress(index){
                this.waitDialog = true
                axios.post('customers/delete_address/'+this.fd.addresses[index].id).then((res)=>{
