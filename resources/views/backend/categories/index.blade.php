	...
	<v-col class="mx-4">
		<v-toolbar dense color="transparent" flat>
			...
			<v-toolbar-items>
				...
				<div>
					<v-btn v-if="meta.create == 'true'" color="primary" dense depressed :href="baseUrl+'/admin/categories/add'">Create</v-btn>
				</div>
			</v-toolbar-items>
		</v-toolbar>
...
<script>
    var vue = new Vue({
        ...
        methods:{
			...
			edit(id){
				window.location.href = this.baseUrl+'/admin/categories/edit/'+id
			},
			deleteConfirm(id){
				this.delete_id = id
