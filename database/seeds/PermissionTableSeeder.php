...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'show_user','guard_name'=>'api','model'=>'User','model_slug'=>'user']);
        ...
        Permission::create(['name'=>'show_product','guard_name'=>'api','model'=>'Product','model_slug'=>'product']);
        ...
        Permission::create(['name'=>'show_customer','guard_name'=>'api','model'=>'Customer','model_slug'=>'customer']);
        ...
        Permission::create(['name'=>'show_taxonomy','guard_name'=>'api','model'=>'Taxonomy','model_slug'=>'taxonomy']);
        ...
        Permission::create(['name'=>'show_category','guard_name'=>'api','model'=>'Category','model_slug'=>'category']);
        ...
        Permission::create(['name'=>'show_warehouse','guard_name'=>'api','model'=>'Warehouse','model_slug'=>'warehouse']);
        ...
        Permission::create(['name'=>'show_pricelist','guard_name'=>'api','model'=>'Pricelist','model_slug'=>'pricelist']);
        ...
        Permission::create(['name'=>'show_sale','guard_name'=>'api','model'=>'Sale Order','model_slug'=>'sale']);
